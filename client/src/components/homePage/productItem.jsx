      ...
      <div className="bg-white rounded-2xl cursor-pointer hover:-translate-y-2 transition-all relative w-[300px]">
        ...
        <div className="overflow-hidden mx-auto md:mb-2 mb-4">
          <img
            src={urlImage}
            alt={name}
            className="w-[300px] h-[400px] object-cover rounded-t-lg"
          />
        </div>
        <div className="m-5">
          <h3 className="text-[18px] font-semibold font-normal line-clamp-2 overflow-hidden text-ellipsis max-w-[200px] min-h-[40px]">
            {name}
          </h3>
