    ...
    (function() {
      ...
      function getComponentNameFromType(type) {
        ...
        if ("object" === typeof type)
          switch ("number" === typeof type.tag && error(
      ...
      function checkKeyStringCoercion(value) {
        ...
        if (JSCompiler_inline_result)
          return JSCompiler_inline_result = "function" === typeof Symbol && Symbol.toStringTag && value[Symbol.toStringTag] || value.constructor.name || "Object", error(
      ...
      function defineKeyPropWarningGetter(props, displayName) {
        function warnAboutAccessingKey() {
          specialPropKeyWarningShown || (specialPropKeyWarningShown = true, error(
      ...
      function elementRefGetterWithDeprecationWarning() {
        ...
        didWarnAboutElementRef[componentName] || (didWarnAboutElementRef[componentName] = true, error(
      ...
      function jsxDEVImpl(type, config, maybeKey, isStaticChildren, source, self) {
        ...
        if (hasOwnProperty.call(config, "key")) {
          ...
          didWarnAboutKeySpread[children + isStaticChildren] || (keys = 0 < keys.length ? "{" + keys.join(": ..., ") + ": ...}" : "{}", error(
